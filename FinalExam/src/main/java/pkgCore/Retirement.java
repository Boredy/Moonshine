...
public class Retirement {
	...
	public void setdRequiredIncome(int dRequiredIncome) {
		this.dRequiredIncome = dRequiredIncome;
	}
	...
	public void setdMonthlySSI(int dMonthlySSI) {
		this.dMonthlySSI = dMonthlySSI;
	}
}
